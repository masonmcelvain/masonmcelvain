         ...
         >
            <Body className="bg-gray-100 font-sans">
               <Container className="mx-auto max-w-xl p-5">
                  <Heading className="text-brand mb-4 text-2xl font-bold">
                     Welcome!
                  </Heading>
                  ...
                  <Button
                     ...
                     className="bg-brand box-border block rounded-lg px-6 py-3 text-center text-white"
                  >
                     Get Started
                  </Button>
               </Container>
...
<Text className="my-4 text-base leading-6 text-gray-800">
...
<Button
   ...
   target="_blank"
   className="box-border block rounded bg-blue-600 px-5 py-3 text-center font-medium text-white no-underline"
>
...
<Text className="text-base text-gray-800">
   Run <CodeInline className="rounded bg-gray-100 px-1">npm install</CodeInline>{" "}
   to get started.
</Text>;
```
