            ...
            <Body className="bg-gray-100 font-sans">
               <Container className="mx-auto max-w-xl p-5">
                  ...
                  <Button
                     ...
                     className="box-border rounded bg-blue-600 px-5 py-3 text-white"
                  >
            ...
            <Body className="bg-gray-100 font-sans">
               ...
               <Container className="mx-auto max-w-xl px-5 py-10">
                  ...
                  <Button
                     ...
                     className="my-5 box-border block rounded bg-blue-600 px-5 py-3 text-center text-white no-underline"
                  >
                     {t("view-order")}
                  </Button>
                  <Hr className="my-5 border-solid border-gray-200" />
