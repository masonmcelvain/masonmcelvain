         ...
         <Tailwind config={{ presets: [pixelBasedPreset] }}>
            ...
            <Body className="bg-gray-100 font-sans">
               ...
               <Container className="mx-auto max-w-xl bg-white px-5 py-10">
                  ...
                  <Text className="my-4 text-base leading-7 text-gray-800">
                     Click the button below to reset your password. This link
         ...
         <Tailwind config={{ presets: [pixelBasedPreset] }}>
            ...
            <Body className="bg-gray-100 font-sans">
               ...
               <Container className="mx-auto max-w-xl px-5 py-10">
                  ...
                  <Heading
                     as="h2"
                     className="my-4 text-xl font-bold text-gray-800"
                  >
                     Order Items
                  </Heading>
                  ...
                  <Text className="mt-8 text-sm text-gray-500">
                     Questions about your order? Reply to this email and we'll
                     help you out.
                  </Text>
               </Container>
            </Body>
            ...
            <Body className="bg-gray-100 font-sans">
               ...
               <Container className="mx-auto max-w-xl bg-white px-5 py-10">
                  ...
                  <Text className="my-4 text-base leading-7 text-gray-800">
                     ...
                     you to join the <strong>{teamName}</strong> team.
                  </Text>
