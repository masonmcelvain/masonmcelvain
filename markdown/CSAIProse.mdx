...
>
   {/* prettier-ignore */}
   <CaptionText>The landing page of the <a href="https://reverent-davinci-cfec49.netlify.app/login" target="_blank">CSAI data cleaning app.</a> Yea, that's CSS 😎</CaptionText>
</CaptionedVideo>
