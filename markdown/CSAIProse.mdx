import { CaptionLink, CaptionText, CaptionedVideo } from "@ui/media";
...
had A.I. developers in spades, they only had one web developer and their <a href="https://csaicalpoly.com/" target="_blank">website</a>
...
>
   {/* prettier-ignore */}
   <CaptionText>The landing page of the <CaptionLink href="https://reverent-davinci-cfec49.netlify.app/login">CSAI data cleaning app.</CaptionLink> Yea, that's CSS 😎</CaptionText>
</CaptionedVideo>
