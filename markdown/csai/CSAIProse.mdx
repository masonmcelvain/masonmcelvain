import { CaptionText, CaptionedVideo } from "@ui/media";
...
had A.I. developers in spades, they only had one web developer and their <ExternalLink href="https://csaicalpoly.com/">website</ExternalLink>
...
<CaptionedVideo
   mp4="/assets/videos/csai-validator.mp4"
   webm="/assets/videos/csai-validator.webm"
>
   {/* prettier-ignore */}
   <CaptionText>The landing page of the
      <ExternalLink href="https://reverent-davinci-cfec49.netlify.app/login">CSAI data cleaning app.</ExternalLink> Yea, that's CSS 😎</CaptionText>
</CaptionedVideo>
