...
>
   {/* prettier-ignore */}
   <Text mt={2} fontSize="sm" color="gray.500">The landing page of the&nbsp;
      <Link href="https://reverent-davinci-cfec49.netlify.app/login" target="_blank" textDecoration="underline">CSAI data cleaning app.</Link> Yea, that's CSS 😎</Text>
</CaptionedVideo>
