...
>
   ...
   <CaptionText>The landing page of the
      <Link href="https://reverent-davinci-cfec49.netlify.app/login" target="_blank" textDecoration="underline">CSAI data cleaning app.</Link> Yea, that's CSS 😎</CaptionText>
</CaptionedVideo>
