...
import { CaptionedImage } from "@ui/image";
...
<Center>
   <CaptionedImage
      src={HopComposite}
      caption="Hop's primary view on the left and edit mode on the right."
      priority
   />
</Center>
...
<Center mt={6}>
   <CaptionedImage
      src={ChromeApplet}
      caption="The Chrome bookmark applet that inspired Hop."
   />
</Center>
