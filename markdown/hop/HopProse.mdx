Hop is a browser extension that stores your top bookmarks in a visually pleasing way.
It's available on the Google Web Store and Firefox Add-ons.
...
Just to get the app up and running, I had to learn how to use Webpack to build my
favorite tools (Typescript and Chakra UI) down to a file structure that Chrome's
extension engine could understand.
